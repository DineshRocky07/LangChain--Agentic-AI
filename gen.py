...
def main():
    ...
    information = """
Elon Reeve Musk (/ˈiːlɒn/ EE-lon; born June 28, 1971) is a businessman and entrepreneur known for his leadership of Tesla, SpaceX, X, and xAI. Musk has been the wealthiest person in the world since 2025; as of April 2026, Forbes estimates his net worth to be around US$823 billion.
...
Elon was an enthusiastic reader of books, and had attributed his success in part to having read The Lord of the Rings, the Foundation series, and The Hitchhiker's Guide to the Galaxy.[11][28] At age ten, he developed an interest in computing and video games, teaching himself how to program from the VIC-20 user manual.[29] At age twelve, Elon sold his BASIC-based game Blastar to PC and Office Technology magazine for approximately $500 (equivalent to $1,600 in 2025).[30][31]"""
    ...
    summary_template ="""
      given then informaction {information} about the person i want you to create :
       1. A short summary
       2. two interesting facts about then
       """
    #promptTemplate use for more realiable debuging very use full
   ...
   # llm = ChatGoogleGenerativeAI(temperature=0, model="gemini-1.5-flash")
    ...
    chain= summary_prompt_template | llm
     ...
     #invoke use because runnable chain and get the response from the llm
